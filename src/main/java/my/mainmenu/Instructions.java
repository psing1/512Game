...
public class Instructions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Players combine tiles containing the same numbers until they reach the number 512.\n   The tiles can contain only integer values starting from 2, and that are a power of\n     two, like 2, 4, 8, 16, 32, and so on. Ideally, the player should reach the 512 tile\n                                        within the smallest number of steps.");

        jLabel1.setBackground(new java.awt.Color(90, 90, 90));
